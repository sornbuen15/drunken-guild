...
The suite includes the following pre-configured skills (located in the [skills/](file:///Users/operator/Projects/drunken-team/skills/) directory) that can be loaded by your Antigravity agents:

*   **[git-workflow](file:///Users/operator/Projects/drunken-team/skills/git-workflow/SKILL.md)**: Enforces Git branching rules, Pull Requests, release workflows, and GitHub CLI (`gh`) best practices.
*   **[next-task](file:///Users/operator/Projects/drunken-team/skills/next-task/SKILL.md)**: Moves high-priority items from the backlog/todo to in-progress using the Jira bridge.
*   **[backlog-refinement](file:///Users/operator/Projects/drunken-team/skills/backlog-refinement/SKILL.md)**: Refines backlog tasks and aligns local items with Jira.
*   **[confluence-sync](file:///Users/operator/Projects/drunken-team/skills/confluence-sync/SKILL.md)**: Syncs local documentation files (Specs, ADRs, etc.) with Confluence Cloud.
*   **[debug-mantra](file:///Users/operator/Projects/drunken-team/skills/debug-mantra/SKILL.md)**: A 4-step disciplined debugging approach (reproduce, trace, falsify, cross-reference).
*   **[management-talk](file:///Users/operator/Projects/drunken-team/skills/management-talk/SKILL.md)**: Rewrites highly technical logs/messages for leadership (VPs, PMs, directors).
*   **[post-mortem](file:///Users/operator/Projects/drunken-team/skills/post-mortem/SKILL.md)**: Standardizes bug post-mortem documentation once a fix is landed.
*   **[project-audit-reviewer](file:///Users/operator/Projects/drunken-team/skills/project-audit-reviewer/SKILL.md)**: Audits codebase health, architecture compliance, and security posture.
*   **[scrutinize](file:///Users/operator/Projects/drunken-team/skills/scrutinize/SKILL.md)**: An independent review flow to audit proposed changes and PRs.
*   **[system-design-rules](file:///Users/operator/Projects/drunken-team/skills/system-design-rules/SKILL.md)**: Guidelines for system architecture, API contracts, and design trade-offs.
*   **[task-estimation](file:///Users/operator/Projects/drunken-team/skills/task-estimation/SKILL.md)**: Standardizes task complexity, requirements, and estimation.
