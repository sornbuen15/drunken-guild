#!/usr/bin/env python3
"""
Setup utility for Drunken Guild local Git hooks.
...
# Drunken Guild Git Pre-Push Hook
...
for line in lines:
    ...
    if remote_ref in PROTECTED_REFS:
        ...
        print(f"\\n[Drunken Guild Hook] 🛑 ERROR: Direct push to protected branch '{branch_name}' is prohibited!")
