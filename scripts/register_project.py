...
"""
    ...
    if not jira_token:
        ...
        global_config_path = "/Users/r.jakkawan/.gemini/config/jira_config.json"
        use_global = False
    ...
    if not discord_token:
        backup_d_conf = "/Users/r.jakkawan/Projects/drunken-agy/.agents/discord_config.json"
    ...
    env_content = f"""# ⚠️ PRIVATE CREDENTIALS - GENERATED BY DRUNKEN-REGISTER
...
"""
    ...
    print(f"[+] สร้างไฟล์ .env ท้องถิ่นเรียบร้อยที่: {env_path}")
