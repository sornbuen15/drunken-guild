...
server launched for DT could move BETA's tickets, succeed, and report success.
One credential reaches DT, ALPHA and BETA, so this is the same hole S8 opened in
