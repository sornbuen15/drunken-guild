...
Card format (Markdown):
    ...
    - **Depends On:** ALPHA-30, ALPHA-31  # optional
    - **Blocks:** ALPHA-35              # optional
...
def parse_card(content: str, filename: str) -> CardData:
    ...
    """
    # --- Task ID from filename: ALPHA-37_slug.md -> ALPHA-37 ---
    ...
    # Fall back for old-style plain-text status blocks (e.g. ALPHA-001)
    if not status_val:
        plain = re.search(
